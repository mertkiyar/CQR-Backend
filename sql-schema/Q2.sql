...
BEGIN
    ...
    FOR i IN 1..250 LOOP 
        ...
        INSERT INTO ATTENDANCE_RECORDS (STUDENT_ID, ATTENDANCE_SESSION_ID, ATTENDANCE_TYPE, DEVICE_ID, CLIENT_IP, ATTEND_AT, IS_LATE)
        SELECT STUDENT_ID, v_session_id, 'QR_CODE', gen_random_uuid(), '127.0.0.1', 
